...
#include <BoltIoT-Arduino-Helper.h>
  ...
  void setup() {
    ...
    pinMode(0,OUTPUT); //Set pin 2 as input. We will send this pin's state as the data to the Bolt Cloud
  }
  void loop() {
    boltiot.CheckPoll(digitalWrite(0,HIGH)); //Send data to the Bolt Cloud, when the Bolt polls the Arduino for data.
